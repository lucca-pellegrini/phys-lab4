...
% Cabeçalho
\fancyhead[L]{Experimento 4}
\fancyhead[C]{\textbf{Atrito Cinético}}
\fancyhead[R]{Laboratório de Física}
...
\begin{table}[p]
	...
	\end{tabular}
	\caption{
		Valores de $\Delta x$, $t$ e $t^2$ medidos e calculados sem
		arredondamento.
	}
	\label{tbl:dados}
\end{table}
...
\texttt{PhysPlot}, de nossa autoria, pode ser encontrado no
